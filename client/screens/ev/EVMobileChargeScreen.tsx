...
export default function EVMobileChargeScreen() {
  ...
  if (requested) {
    return (
      <View style={[styles.container, { backgroundColor: EV.bg }]}>
        <LinearGradient
          colors={["#00FF8810", "#00E5FF08", "transparent"]}
          start={{ x: 0.5, y: 0 }}
          end={{ x: 0.5, y: 0.5 }}
        ...
        <View style={[styles.confirmedContainer, { paddingTop: insets.top + 60, paddingBottom: insets.bottom + 20 }]}>
          ...
          <Animated.Text style={styles.confirmedTitle}>Charge Unit Dispatched</Animated.Text>
          ...
          <View style={[styles.confirmedCard, { borderColor: EV.neonGreen + "20" }]}>
            <View style={styles.confirmedRow}>
              <Animated.Text style={styles.confirmedLabel}>Charge Level</Animated.Text>
              <Animated.Text style={styles.confirmedValue}>{CHARGE_LEVELS[selectedLevel].label}</Animated.Text>
            </View>
            <View style={[styles.confirmedDivider, { backgroundColor: EV.border }]} />
            <View style={styles.confirmedRow}>
              <Animated.Text style={styles.confirmedLabel}>Energy</Animated.Text>
              <Animated.Text style={styles.confirmedValue}>{CHARGE_LEVELS[selectedLevel].kwh}</Animated.Text>
            </View>
            <View style={[styles.confirmedDivider, { backgroundColor: EV.border }]} />
            <View style={styles.confirmedRow}>
              <Animated.Text style={styles.confirmedLabel}>Est. Time</Animated.Text>
              <Animated.Text style={styles.confirmedValue}>{CHARGE_LEVELS[selectedLevel].time}</Animated.Text>
            </View>
            <View style={[styles.confirmedDivider, { backgroundColor: EV.border }]} />
            <View style={styles.confirmedRow}>
          ...
          <Pressable
            ...
            style={styles.backToEvButton}
          >
            <Animated.Text style={styles.backToEvText}>Back to EV Hub</Animated.Text>
          </Pressable>
        </View>
      </View>
    );
  ...
  return (
    <View style={[styles.container, { backgroundColor: EV.bg }]}>
      <LinearGradient
        colors={["#00E5FF08", "#00FF8805", "transparent"]}
        start={{ x: 0.5, y: 0 }}
        end={{ x: 0.5, y: 0.4 }}
        style={StyleSheet.absoluteFill}
      />
      ...
      >
        ...
        <View style={styles.header}>
          <Animated.Text style={styles.headerLabel}>MOBILE CHARGING</Animated.Text>
          <View style={styles.headerTitleRow}>
            <Animated.View style={pulseStyle}>
              <Feather name="zap" size={24} color={EV.neonCyan} />
            </Animated.View>
            <Animated.Text style={styles.headerTitle}>Charge On-Demand</Animated.Text>
          </View>
        ...
        {defaultVehicle ? (
          <View style={[styles.vehicleCard, { borderColor: EV.neonCyan + "25" }]}>
            ...
            <View style={styles.batteryMini}>
              <Animated.Text style={styles.batteryMiniText}>73%</Animated.Text>
            </View>
          </View>
        ) : null}

        <Animated.Text style={styles.sectionTitle}>Select Charge Level</Animated.Text>
        ...
        {CHARGE_LEVELS.map((level, index) => {
          ...
          return (
            ...
            >
              ...
              <Animated.Text style={styles.levelDesc}>{level.desc}</Animated.Text>
              <View style={styles.levelMeta}>
                <View style={styles.levelMetaItem}>
                  <Feather name="battery-charging" size={12} color={EV.whiteDim} />
                  <Animated.Text style={styles.levelMetaText}>{level.kwh}</Animated.Text>
                </View>
                <View style={styles.levelMetaItem}>
                  <Feather name="clock" size={12} color={EV.whiteDim} />
                  <Animated.Text style={styles.levelMetaText}>{level.time}</Animated.Text>
                </View>
              </View>
            </Pressable>
          );
        ...
        <View style={[styles.locationCard, { borderColor: EV.border }]}>
          <Feather name="map-pin" size={18} color={EV.neonGreen} />
          <View style={{ flex: 1, marginLeft: 12 }}>
            <Animated.Text style={styles.locationTitle}>Charge Location</Animated.Text>
            <Animated.Text style={styles.locationAddr}>
...
const styles = StyleSheet.create({
  ...
  batteryMiniText: { color: "#00FF88", fontSize: 13, fontWeight: "700" },
  sectionTitle: {
    color: "#F0F4FF",
    fontSize: 17,
    fontWeight: "700",
  ...
  levelDesc: { color: "#8892A8", fontSize: 13, lineHeight: 18, marginBottom: 10 },
  levelMeta: { flexDirection: "row", gap: 20 },
  levelMetaItem: { flexDirection: "row", alignItems: "center", gap: 5 },
  levelMetaText: { color: "#8892A8", fontSize: 12 },
  locationCard: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: "#0C0C1E",
  ...
  locationTitle: { color: "#F0F4FF", fontSize: 14, fontWeight: "600" },
  locationAddr: { color: "#8892A8", fontSize: 12, marginTop: 2 },
  infoRow: {
    flexDirection: "row",
  ...
  infoText: { color: "#4A5068", fontSize: 12, flex: 1, lineHeight: 17 },
  ...
  confirmedPin: { color: "#00FF88", fontSize: 16, fontWeight: "700", letterSpacing: 2, marginBottom: 28 },
  backToEvButton: {
    borderWidth: 1,
  ...
  backToEvText: { color: "#00E5FF", fontSize: 15, fontWeight: "700" },
});
