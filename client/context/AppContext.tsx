...
export const BACKGROUND_SCHEMES: Record<BackgroundColorScheme, SchemeConfig> = {
  ...
  ocean: {
    ...
    bgColorLight: "#E0F7FA",
    flashColor: "#00BCD4",
    flashColorLight: "#0097A7",
    colors: [["#006994", "#004E71"], ["#00BCD4", "#0097A7"], ["#26C6DA", "#00838F"], ["#004D40", "#00695C"], ["#0097A7", "#00BCD4"], ["#00838F", "#004D40"]],
    colorsLight: [["#80DEEA", "#4DD0E1"], ["#B2EBF2", "#80DEEA"], ["#E0F7FA", "#B2EBF2"], ["#4DD0E1", "#80DEEA"], ["#80DEEA", "#B2EBF2"], ["#26C6DA", "#4DD0E1"]],
    opacityBoost: 1.6,
  ...
  sunset: {
    ...
    bgColorLight: "#FFF8E1",
    flashColor: "#FF6D00",
    flashColorLight: "#E65100",
    colors: [["#FF6D00", "#E65100"], ["#FFD600", "#FFAB00"], ["#FF1744", "#D50000"], ["#FF9100", "#FF6D00"], ["#FFD600", "#FF1744"], ["#E65100", "#FF9100"]],
    colorsLight: [["#FFCC80", "#FFB74D"], ["#FFF9C4", "#FFF176"], ["#FFCDD2", "#EF9A9A"], ["#FFE0B2", "#FFCC80"], ["#FFF9C4", "#FFCDD2"], ["#FFB74D", "#FFE0B2"]],
    opacityBoost: 1.7,
  ...
  aurora: {
    ...
    bgColorLight: "#E8F5E9",
    flashColor: "#00E676",
    flashColorLight: "#00C853",
    colors: [["#00E676", "#00C853"], ["#69F0AE", "#00E676"], ["#00BFA5", "#1DE9B6"], ["#76FF03", "#64DD17"], ["#1DE9B6", "#00E676"], ["#00C853", "#00BFA5"]],
    colorsLight: [["#A5D6A7", "#81C784"], ["#C8E6C9", "#A5D6A7"], ["#B2DFDB", "#80CBC4"], ["#CCFF90", "#B9F6CA"], ["#80CBC4", "#A5D6A7"], ["#81C784", "#B2DFDB"]],
    opacityBoost: 1.5,
    opacityBoostLight: 0.55,
  },
  midnight: {
    ...
    bgColorLight: "#EDE7F6",
    flashColor: "#B388FF",
    flashColorLight: "#7C4DFF",
    colors: [["#B388FF", "#7C4DFF"], ["#7C4DFF", "#651FFF"], ["#EA80FC", "#E040FB"], ["#651FFF", "#4A148C"], ["#D500F9", "#AA00FF"], ["#4A148C", "#EA80FC"]],
    colorsLight: [["#D1C4E9", "#B39DDB"], ["#B39DDB", "#9575CD"], ["#F3E5F5", "#E1BEE7"], ["#9575CD", "#B39DDB"], ["#E1BEE7", "#CE93D8"], ["#B39DDB", "#F3E5F5"]],
    opacityBoost: 1.8,
    opacityBoostLight: 0.65,
  },
  ember: {
    ...
    bgColorLight: "#FBE9E7",
    flashColor: "#FF3D00",
    flashColorLight: "#DD2C00",
    colors: [["#FF3D00", "#DD2C00"], ["#FF6E40", "#FF3D00"], ["#FF1744", "#C62828"], ["#DD2C00", "#BF360C"], ["#C62828", "#B71C1C"], ["#BF360C", "#FF1744"]],
    colorsLight: [["#FFAB91", "#FF8A65"], ["#FFCCBC", "#FFAB91"], ["#EF9A9A", "#E57373"], ["#FF8A65", "#FFAB91"], ["#E57373", "#EF9A9A"], ["#FFCCBC", "#EF9A9A"]],
    opacityBoost: 1.7,
    opacityBoostLight: 0.55,
  },
  noir: {
    ...
    bgColorLight: "#F5F5F5",
    flashColor: "#757575",
    flashColorLight: "#616161",
    colors: [["#9E9E9E", "#616161"], ["#757575", "#424242"], ["#BDBDBD", "#757575"], ["#616161", "#212121"], ["#9E9E9E", "#424242"], ["#757575", "#212121"]],
    colorsLight: [["#E0E0E0", "#BDBDBD"], ["#EEEEEE", "#E0E0E0"], ["#F5F5F5", "#EEEEEE"], ["#BDBDBD", "#E0E0E0"], ["#E0E0E0", "#9E9E9E"], ["#EEEEEE", "#BDBDBD"]],
    opacityBoost: 2.2,
