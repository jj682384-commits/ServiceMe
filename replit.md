...
- **Animated Background System**: Fixed-brand animated particle system matching the ResqRide logo palette — electric blue/cyan particles, fire red/orange particles, white star particles, with electric arc connections and a scrolling EKG/heartbeat line at 82% screen height. No user customization; one unified look across all screens.
